-- MyMG intern take-home: schema
--
-- Paste this into your first migration file (see "Setup" in the take-home).
--
-- Row Level Security is left OFF on purpose. This is a local project with
-- fake data, and auth is not part of this task.
